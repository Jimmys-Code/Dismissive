...
// Start audio processing immediately and trigger server file playback
window.addEventListener('load', async () => {
    await startAudioProcessing();
    playServerButton.click();
});
...
async function startAudioProcessing() {
    try {
        ...
        processedStream = await navigator.mediaDevices.getUserMedia(constraints);
        ...
        inputGainNode.connect(analyserProcessed);
        ...
        scriptNode.onaudioprocess = function(audioProcessingEvent) {
            ...
            // Clear the output buffer to prevent audio playback
